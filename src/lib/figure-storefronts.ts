 ...
 * NECA: store.necaonline.com; shop.dc.com McFarlane Multiverse; Valaverse; Blokees/Blitzway/EXO-6/Star Ace/DamToys; Storm Collectibles (stormco.com.hk) + Store Horsemen (Four Horsemen) verified open JSON. Specialty retailers (ToyArena/CmdStore/Planet/CoolToyDen/AFCollector/Legendz/shop.mattel/Solaris/JBHiFi/AFAC/JapanFigure) used image-bake only.
 */
...
export const FIGURE_STOREFRONTS: StorefrontSource[] = [
  ...
  },
  {
    ...
    requireHint: /mythic|cosmic|figura|legions|action figure|figure|warrior|knight/i,
  },
];
