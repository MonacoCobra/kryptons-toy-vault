...
const TF_3P = new Set([
  ...
  "drwu",
  "unbranded",
  // showzstore-3p-official: DJS plus Show.Z makers so they stay on Transformers 3P
  "djs",
  "galaxytoys",
  "bigfirebird",
  "luckycat",
  ...
  "startoy",
  "toysstar",
  "mechanicalskullstudio",
  "bananaforce",
  "papatoys",
  "tfm",
  "transformandrollout",
  "bailantoys",
  "transformersmovietoys",
  "jing",
  "transcraft",
  "cdl",
  "scifigureindustry",
  ...
  "toysalliance",
  "lutiesheng",
  "xinggangmechanicalplanetcybertron",
  "transformdreamwave",
  "jinggongfactory",
  "gione",
  "lijiangrobot",
  "pocketmonuments",
  "lijiang",
  "madhandtoysandnakomake",
  "emonsterem04",
  "justoys",
  "ntf",
  "bowuschoolshenyang",
  "transformmissionhavoc",
  "cyberfactorycf01",
  "tryacetoys",
  "movableandmetalarts",
  "bluelobster",
  "threea",
  "civilwarriorgeneralgrant",
  "garatron",
  "toystory",
  "shadowfisher",
  "wildkidsdisplaybases",
  "mistermoon",
  "ace",
  "tranformmissionhavocsetof",
  "tfevo",
]);
