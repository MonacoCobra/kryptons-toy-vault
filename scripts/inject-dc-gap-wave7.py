#!/usr/bin/env python3
"""Inject curated DC gap wave7 into oneshot archive. No Build Publish."""
...
from figure_oneshot.curated_dc_gap_wave7 import build_dc_gap_wave7

ARCHIVE = ROOT / "src/data/figure-archive/oneshot.json"
STATS = ROOT / "src/data/figure-archive/dc-gap-wave7-inject-stats.json"
SOURCE = "curated-dc-gap-wave7"
...
def main() -> None:
    ...
    for r in curated:
        ...
        if k in keys:
            skipped["key"] += 1
            continue
        # Exact-key soft-dedupe only (do not wipe legitimate subtitle variants)
        r.pop("imageUrl", None)
