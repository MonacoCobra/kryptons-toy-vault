#!/usr/bin/env python3
"""Inject curated DC gap wave6 into oneshot archive. No Build Publish."""
...
from figure_oneshot.curated_dc_gap_wave6 import build_dc_gap_wave6

ARCHIVE = ROOT / "src/data/figure-archive/oneshot.json"
STATS = ROOT / "src/data/figure-archive/dc-gap-wave6-inject-stats.json"
SOURCE = "curated-dc-gap-wave6"
