#!/usr/bin/env python3
"""Inject curated DC gap wave8 into oneshot archive. No Build Publish."""
...
from figure_oneshot.curated_dc_gap_wave8 import build_dc_gap_wave8

ARCHIVE = ROOT / "src/data/figure-archive/oneshot.json"
STATS = ROOT / "src/data/figure-archive/dc-gap-wave8-inject-stats.json"
SOURCE = "curated-dc-gap-wave8"
